...
namespace EntityObjects.Cards.Wild
{
    public class DevilsDeal : ICard
    {
        ...
        public string Description => "When the card is played, player can choose to activate the effect or not. If yes, all players with only one card remaining (counted the card is played) must draw a card. The owner must draw 2 cards in return, and this card will be moved back to his hand. Acts as normal wild card otherwise.";
