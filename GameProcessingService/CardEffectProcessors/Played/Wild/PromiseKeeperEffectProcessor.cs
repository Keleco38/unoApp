...
namespace GameProcessingService.CardEffectProcessors.Played.Wild
{
    public class PromiseKeeperEffectProcessor : IPlayedCardEffectProcessor
    {
        ...
        public MoveResult ProcessCardEffect(Game game, MoveParams moveParams)
        {
            ...
            messagesToLog.Add($"{moveParams.PlayerPlayed.User.Name} changed color to {moveParams.TargetedCardColor} (promise keeper). They also picked a card they will discard next turn.");
